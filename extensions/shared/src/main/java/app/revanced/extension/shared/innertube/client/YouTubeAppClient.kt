...
object YouTubeAppClient {
    ...
    private val DEVICE_MODEL_IOS = if (forceAVC())
        "iPhone17,2" // 16 Pro Max. ( with iOS 18)
    else
        "iPhone18,2" // 16 Pro Max.
    private val OS_VERSION_IOS = if (forceAVC())
        "18.0.22A3354" // with iOS 18.
    else
        "26.0.23A345"
    ...
    private const val CLIENT_VERSION_ANDROID_UNPLUGGED = "10.30.1"
    ...
    private const val GMS_CORE_VERSION_CODE_ANDROID_UNPLUGGED = "262833019"
    ...
    private const val CLIENT_VERSION_ANDROID_CREATOR = "26.10.000"
